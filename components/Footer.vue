<template>
    <footer id="footer" class="footer p-10 bg-base-100 text-base-content dark:bg-base-content dark:text-base-200">
    <div>
      <span class="footer-title">Seções</span> 
      <a class="link link-hover">Home</a> 
      <a class="link link-hover">Sobre</a> 
      <a class="link link-hover">Tecnologias</a> 
      <a class="link link-hover">Frameworks</a>
    </div> 
    <div>
      <span class="footer-title">Contato</span> 
      <a class="link link-hover">Portfólio</a> 
      <a class="link link-hover">Blog</a> 
      <a class="link link-hover">Currículo</a> 
      <a class="link link-hover">Outras Aplicações</a>
    </div> 
    <div>
  ...
  <footer class="footer px-10 py-4 border-t bg-base-100 text-base-content dark:bg-base-content dark:text-base-200">
    <div class="items-center grid-flow-col">
      ...
      <p>ANDRE RIFFEN <br/>No mundo desde 1993, fuçando na internet desde 2003.</p>
      <p>(nenhum dos links abaixo funcionam, esta bagaça é só um protótipo)</p>
    </div> 
